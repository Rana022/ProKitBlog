		...
		<div class="swiper-container position-static" data-slide-effect="slide" data-autoheight="false"
			...
			<div class="swiper-wrapper">
                @foreach ($categories as $row)
					...
					<a class="slider-category" href="{{route('category.posts',$row->slug)}}">
					<div class="blog-image"><img src="{{asset('public/storage/category/slider/'.$row->image)}}" alt="{{$row->name}}"></div>
