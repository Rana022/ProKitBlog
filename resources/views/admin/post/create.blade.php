            ...
            <div class="row clearfix">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <div class="form-group">
                                    <label for="image">Fearure Image</label>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <div class="form-group form-float {{$errors->has('categories') ? 'focus-error' : ''}}">
                                    <label for="select-form">Select Category</label>
                                ...
                                <div class="form-group form-float {{$errors->has('tags') ? 'focus-error' : ''}}">
                                    <label for="select-form">Select Tag</label>
