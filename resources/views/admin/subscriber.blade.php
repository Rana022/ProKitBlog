...
<section class="content">
        <div class="container-fluid">
            ...
            <a href="{{route('admin.tag.create')}}" class="btn btn-primary waves-black">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <form id="delete-form-{{$row->id}}" action="{{route('admin.subscriber.destroy', $row->id)}}" method="post" style="display:none">
                                        @csrf
                                        @method('DELETE')
                                        </form>
